...
ggsave("figures/SI/Convergence/trank_europe.png", width = 8, height = 8)
...
ggsave("figures/SI/Convergence/trank_pyrenees.png", width = 8, height = 8)
...
ggsave("figures/SI/Convergence/coef_plot.png", coef_plot, width = 7)
